...
@Component({
  selector: 'app-carouselmenutacos',
  templateUrl: './carouselmenutacos.component.html',
  styleUrls: ['./carouselmenutacos.component.css']
})
export class CarouselmenutacosComponent {
  coeur: boolean = false;
